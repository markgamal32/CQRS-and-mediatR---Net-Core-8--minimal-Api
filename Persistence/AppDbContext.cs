	...
	public class AppDbContext : DbContext
	{
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Product>().HasData(
				new Product("iPhone 15 Pro", "Apple's latest flagship smart-phone with a ProMotion display and improved cameras", 999.99m),
		...
		{
			optionsBuilder.UseInMemoryDatabase("code-with-Mark-Gamal");
		}
